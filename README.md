...
**En twee combi-projecten zijn gesplitst, elk met eigen prijs en eigen effect.** "Toiletten en kleedkamers" (€55.000) werd **Toiletten** (€30.000 — gezinnen blijven langer: meer toeschouwers en kantineomzet) en **Kleedkamers** (€38.000 — het complex oogt verzorgd: toeschouwers, en je vrijwilligers zijn er trots op). "Zonnepanelen en ledverlichting" werd **Zonnepanelen** (−14% vaste kosten, prijs naar je complexgrootte) en **Ledverlichting** (−6%, klaar in twee weken — de kleinste groene stap om mee te beginnen). Samen drukken ze de factuur ongeveer evenveel als de oude combi. Opslagbestanden migreren naar versie 36: wie de combi had, krijgt beide helften; een lopende sanitair-werf bouwt door als toiletten.
