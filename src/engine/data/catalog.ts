...
export const TASKS: TaskDef[] = [
  {
    ...
    owner: 'Jij kiest hoeveel keer per week er getraind wordt en waarop (Ploeg › Strategie).',
  ...
  },
  {
    ...
    owner: 'Jij kiest de formatie en wie er in de basis staat (Ploeg › Selectie).',
  ...
  },
  {
    ...
    owner: 'Jij kiest de mentaliteit en het spelplan voor de volgende wedstrijd (Ploeg › Strategie).',
  ...
  },
  {
    ...
    roles: ['hoofdtrainer', 'assistent'],
    owner: 'Jij duidt de kapitein en de nemers aan (Ploeg › Selectie).',
  ...
  },
  {
    ...
    roles: ['commercieel'],
    owner: 'Jij benadert bedrijven, tekent aanbiedingen en verlengt contracten (Geld › Sponsors).',
  ...
  },
  {
    ...
    label: 'Ticketprijs',
    roles: ['commercieel'],
    owner: 'Jij stelt de ticketprijs in (Geld › Financiën).',
  ...
  },
  {
    ...
    label: 'Evenementen',
    roles: ['kantine'],
    owner: 'Jij organiseert evenementen (Club › Evenementen).',
  ...
  },
  {
    ...
    owner: 'Jij werft vrijwilligers en bedankt ze (Club › Evenementen).',
