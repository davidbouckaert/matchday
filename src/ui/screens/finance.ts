...
export function financeScreen(s: GameState, selectedCase?: string, backLabel?: string): string {
  ...
  <div class="cols-2">
    ...
    <section class="card">
      ...
      <details><summary>Hoe beoordeelt de bank dit?</summary><p class="small">De bank rekent met huidig beleid en publiek, inclusief winterstop en aflopende sponsorcontracten, en vraagt 10% buffer bovenop alle afbetalingen. Geleend geld, transfers en subsidies tellen niet als draagkracht. Bij een grotere totale bankschuld wordt de looptijd van nieuw infrastructuurkrediet korter: je betaalt meer per week, maar minder lang. Lopende leningen houden hun afgesproken termijn. Een passende raming garandeert nog geen goedkeuring. Meer ruimte nodig? Bekijk je personeelskosten, ticketprijzen en sponsorinkomsten.</p>
