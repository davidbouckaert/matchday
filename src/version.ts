...
export const CHANGELOG: ChangeEntry[] = [
  {
    version: '0.84.5',
    date: '2026-09-26',
    title: 'De bank kijkt naar alle afbetalingen; aanvraagstatus en vaardigheidsbalken worden duidelijker',
    items: [
      'De bank kijkt naar alle afbetalingen; aanvraagstatus en vaardigheidsbalken worden duidelijker',
    ],
  },
  {
    version: '0.84.4',
    date: '2026-09-25',
    title: 'Werk vlotter op tablet en keer terug naar je oorspronkelijke taak',
    items: [
      'Werk vlotter op tablet en keer terug naar je oorspronkelijke taak',
    ],
  },
  {
    version: '0.84.3',
    date: '2026-09-25',
    title: 'Vergelijk personeel, lees de stand en herken urgente clubzaken duidelijker',
    items: [
      'Vergelijk personeel, lees de stand en herken urgente clubzaken duidelijker',
    ],
  },
  {
    version: '0.84.2',
    date: '2026-09-25',
    title: 'Behoud je plek na een subsidiedossier en verwijder oude teruglinks',
    items: [
      'Behoud je plek na een subsidiedossier en verwijder oude teruglinks',
    ],
  },
  {
    version: '0.84.1',
    date: '2026-09-25',
    title: 'Volg je subsidiedossier, zie wat je moet regelen en leer je club stap voor stap kennen',
    items: [
      'Volg je subsidiedossier, zie wat je moet regelen en leer je club stap voor stap kennen',
    ],
  },
  {
    version: '0.84.0',
  ...
  },
  {
    version: '0.83.0',
    date: '2026-09-25',
    title: 'De voedingsdeskundige hoort bij je medische cel, en het volledige voedingsplan bestaat alleen mét hem op de payroll',
    items: [
      'De voedingsdeskundige hoort bij je medische cel, en het volledige voedingsplan bestaat alleen mét hem op de payroll',
    ],
  },
  {
    version: '0.82.0',
    date: '2026-09-25',
    title: 'De rondleiding leert je nu ook de wisselbank kennen, en de weekknoppen krijgen sneltoetsen (Ctrl/Cmd+Enter en B)',
    items: [
      'De rondleiding leert je nu ook de wisselbank kennen, en de weekknoppen krijgen sneltoetsen (Ctrl/Cmd+Enter en B)',
    ],
  },
  {
    version: '0.81.0',
  ...
  },
  {
    version: '0.80.12',
    date: '2026-09-25',
    title: 'Werkafspraak: ook sessiewerk via branches en pull requests',
    items: [
      'Werkafspraak: ook sessiewerk via branches en pull requests',
    ],
  },
  {
    version: '0.80.11',
    date: '2026-09-25',
    title: 'fix: kaartjes bovenaan transfermarkt links uitgelijnd',
    items: [
      'fix: kaartjes bovenaan transfermarkt links uitgelijnd',
    ],
  },
  {
    version: '0.80.10',
    date: '2026-09-25',
    title: 'fix: vraagprijsveld en actieknoppen op transfermarkt lijnen nu recht uit',
    items: [
      'fix: vraagprijsveld en actieknoppen op transfermarkt lijnen nu recht uit',
    ],
  },
  {
    version: '0.80.9',
    date: '2026-09-25',
    title: 'fix: laat \'verloren-reeks\' pas vuren bij de echte laatste drie plaatsen',
    items: [
      'fix: laat \'verloren-reeks\' pas vuren bij de echte laatste drie plaatsen',
    ],
  },
  {
    version: '0.80.8',
    date: '2026-09-25',
    title: 'fix: financiering telt niet mee voor het inkomstenrecord',
    items: [
      'fix: financiering telt niet mee voor het inkomstenrecord',
    ],
  },
  {
    version: '0.80.7',
    date: '2026-09-25',
    title: 'fix: kaartjes bovenaan transfermarkt gelijke hoogte en volle breedte',
    items: [
      'fix: kaartjes bovenaan transfermarkt gelijke hoogte en volle breedte',
    ],
  },
  {
    version: '0.80.6',
    date: '2026-09-25',
    title: 'fix: gebruik de zelfgekozen clubnaam in het welkomstbericht',
    items: [
      'fix: gebruik de zelfgekozen clubnaam in het welkomstbericht',
    ],
  },
  {
    version: '0.80.5',
    date: '2026-09-25',
    title: 'fix: kaartjes bovenaan transfermarkt naast elkaar i.p.v. onder elkaar',
    items: [
      'fix: kaartjes bovenaan transfermarkt naast elkaar i.p.v. onder elkaar',
    ],
  },
  {
    version: '0.80.4',
    date: '2026-09-25',
    title: 'feat: onderwerp-emoji\'s in nieuwsberichten',
    items: [
      'feat: onderwerp-emoji\'s in nieuwsberichten',
    ],
  },
  {
    version: '0.80.3',
    date: '2026-09-25',
    title: 'Feature: filter op transfermarkt spelers',
    items: [
      'Feature: filter op transfermarkt spelers',
    ],
  },
  {
    version: '0.80.2',
    date: '2026-09-25',
    title: 'Delete .github/workflows/test.txt',
    items: [
      'Delete .github/workflows/test.txt',
    ],
  },
  {
    version: '0.80.1',
    date: '2026-09-25',
    title: 'fix: ontslag hoofdtrainer valt op, nieuws verhuist naar zijkolom',
    items: [
      'fix: ontslag hoofdtrainer valt op, nieuws verhuist naar zijkolom',
    ],
  },
  {
    version: '0.80.0',
